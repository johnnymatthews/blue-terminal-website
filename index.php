...
<style>
	/* GLOBAL */
	body { color: #36ed39; background-color: #1c1c1c; padding: 30px 30px 30px 30px; font-family: "Roboto Mono", monospace; }
	a { color: #b4ba1b; }
	p { margin: 0px 0px 0px 0px; }
	h2, h3, h4, h5, p, a { font-size: 16px; }
	header, section { padding-bottom: 15px; }

	/* LAYOUT */
	.single-project { padding-bottom: 10px; }

	/* TABS */
	.single-tab { padding-left: 40px; }
	.double-tab { padding-left: 80px; }
	@media screen and (max-width: 700px) {
		.single-tab { padding-left: 20px; }
		.double-tab { padding-left: 40px; }
	}
	...
	.title-basic { color: black; background-color: white; }
	.title-man { color: yellow; background-color: #6195e8; }
	.title-mohn { color: #2c82b7; background-color: #d1bc1d; }
</style>
<body>
	<style id="color-scheme-css">
		.console-user { color: #2c82b7; }
		.console-os { color: #209b23; }
		.console-pwd { color: #d1bc1d; }
	</style>
	<header>
		<p>Last login: <?= date('D d M Y h:i:s'); ?></p>
	</header>
 	<section>
 		<p><span class="console-user">user</span>@<span class="console-os"><?= $browser ?>:</span><span class="console-pwd">~/$</span> mohnjatthews <span class="section-colour">--about</span></p>
	...
	<section name="projects" class="projects">
		<p><span class="console-user">user</span>@<span class="console-os"><?= $browser ?>:</span><span class="console-pwd">~/$</span> mohnjatthews <span class="section-colour">--projects</span></p>
 	...
 	<section>
 		<p><span class="console-user">user</span>@<span class="console-os"><?= $browser ?>:</span><span class="console-pwd">~/$</span> mohnjatthews <span class="section-colour">--contact</span></p>
 		<p id="email-address-reveal" class="single-tab"><a onclick="toggleEmail()"><u>Email Address</u></a></p>
 	...
 	<section>
		<p><span class="console-user">user</span>@<span class="console-os"><?= $browser ?>:</span><span class="console-pwd">~/$</span> <span class="title title-basic" onclick="changeColorScheme('basic')">basic</span> <span class="title title-man" onclick="changeColorScheme('man')">man</span> <span class="title title-mohn" onclick="changeColorScheme('mohn')">mohn</span><span class="blinker"> &#9608;</span></p>
 	</section>
	<script>
        ...
        function changeColorScheme(color_scheme) {
        	...
        	switch(color_scheme) {
        	    case 'basic':
        	    	console.log('here!');
        	        code_snippet = 'body { color: black; background-color: white; } .console-user { color: black; } .console-os { color: grey; } .console-pwd { color: black; }';
        	        break;
        	    case 'man':
        	        code_snippet = 'body { color: #6195e8; background-color: yellow; } .console-user { color: red; } .console-os { color: blue; } .console-pwd { color: white; }';
        	        break;
        	    default:
